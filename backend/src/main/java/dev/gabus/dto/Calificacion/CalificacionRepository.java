...
public interface CalificacionRepository extends JpaRepository<Calificacion, Long> {
    ...
    //Buscar todas las notas de una materia en un trimestre: SELECT * FROM _calificacion WHERE materia_id = ? AND trimestre_id = ?
    List<Calificacion> findByMateriaIdAndTrimestreId(Long materiaId, Long trimestreId);
    ...
    List<Calificacion> findByEstudianteIdAndMateriaIdAndTrimestreId(Long estudianteId, Long materiaId, Long trimestreId);ge
